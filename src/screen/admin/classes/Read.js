...
export default function Read() {
    ...
    const DetailsComponent = (props) => {
        const { rowData} = props;
        return (
            <td  variant="primary"><BtnDetail to={`/admin/class/read/${rowData._id}`}> Details </BtnDetail></td>
        );
    };
    ...
    const DeleteComponent = (props) => {
        const { rowData} = props;
        return (
            <td variant="danger"><BtnDelete to={`/admin/class/delete/${rowData._id}`}>Delete</BtnDelete></td>
        );
    };
    ...
    const EditComponent = (props) => {
        const { rowData} = props;
        return (
            <td ><BtnEdit to={`/admin/class/edit/${rowData._id}`}>Edit</BtnEdit></td>
        );
    };
                ...
                <Aux>
                    <Row>
                        <Col>
                            <Card>
                                <Card.Header>
                                    <Card.Title as="h5">Classes </Card.Title>
