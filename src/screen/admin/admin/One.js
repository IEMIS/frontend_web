...
export default function One() {
    ...
    const {firstName, lastName, middleName, phone, email, level, error, loading, reload, redirectToPage } = values
        ...
        <Aux>
            ...
            <Row>
                <Card.Body>
                    ...
                    <Col>Phone Number : {phone}</Col><Col>email : {email}</Col><Col>Level : {level}</Col>
                </Card.Body>
            </Row>
        </Aux>
    )
