...
export default function Create() {
    ...
    const {studentCode, school, parent,presentClass,classList, stream, firstName, middleName, lastName, gender, religion, dob,country, disability, yearAdmission, HadEce,subject, status, session, province,ethnicity, loading, redirectToPage, schoolList,parentList,subjectList,sessionList} = values
    ...
    React.useEffect(() => {
        const bootstrap = async () =>{
            ...
            setValues(v => ({...v, schoolList:scho.data, sessionList:sessionL,  classList:classL})); 
        }
        bootstrap()
    }, [])
