...
export default function Edit() {
    ...
    React.useEffect(() => {
        const bootstrap = async () =>{
            ...
            //console.log({stud})
            const {studentCode, schoolId, parent, presentClass, stream, firstName, middleName, lastName, gender, religion, dob, country, disability, yearAdmission, HadEce, subject, province } = stud
