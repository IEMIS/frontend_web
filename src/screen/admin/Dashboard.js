            ...
            <Aux>
                <Row>
                    <Col md={6} xl={4}>
                        <Card>
                            <Card.Body>
                                <h6 className='mb-4'>Total Numbers of Students</h6>
                                <div className="row d-flex align-items-center">
                                    <div className="col-9">
                                        <h3 className="f-w-300 d-flex align-items-center m-b-0"><i className="feather icon-arrow-up text-c-green f-30 m-r-5"/> 1,000</h3>
                                    </div>
                    ...
                    <Col xl={4}>
                        <Card>
                            <Card.Body>
                                <h6 className='mb-4'>Total Number of Disctricts</h6>
                                <div className="row d-flex align-items-center">
                                    <div className="col-9">
                    ...
                    <Col md={6} xl={8}>
                        <Card className='Recent-Users'>
                            ...
                            <Card.Body className='px-0 py-2'>
                                <NVD3Chart type="multiBarChart" datum={data} x="x" y="y" height={380} showValues groupSpacing={0.5} />
                            </Card.Body>
                        </Card>
                    </Col>
                    <Col md={6} xl={4}>
