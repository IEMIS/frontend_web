                ...
                {/* slider-area */}
                    ...
                    <div className="slider-overflow">
                        ...
                        <div className="col-xl-5 col-lg-6">
                            ...
                            <h2 className="wow slideInLeft" data-wow-delay="0.2s">Thinking <span>Software</span> High Quality</h2>
                            <p className="wow slideInLeft" data-wow-delay="0.4s">Lorem ipsum dolor sit amet, con sectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna eiusmod aliqua.</p>
                            <a href="fake" className="btn wow slideInLeft" data-wow-delay="0.6s">Start now</a>
                            </div>
                        </div>
                ...
                <div className="row">
                    ...
                    <div className="footer-widget mb-50">
                        ...
                        <ul>
                            ...
                            <li><a href="fake"><i className="fas fa-caret-right" /> Refund Policy</a></li>
                        </ul>
                        </div>
                    </div>
                    </div>
