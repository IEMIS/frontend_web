                ...
                <Row style={{paddingTop:"20px"}}>
                    <Col xl={12} md={12} lg={12}>
                        <Card>
                            ...
                            <Card.Body>
                                <p>
                                IEMIS is cloud native application developed to aid education data collection, improve automation of quality data generation for planning and policy making. It is accessible to all stakeholders and provides real-time education data that would normally take weeks/months to get in a dissaggregated visualized forms. 
                                </p>
                                <p>
                                ...
                                <p> 
                                This IEMISv1.0 (version) is a Minimum Viable Product (MVP) due to circumstances beyond target (pandemic, unavailability of historical data and time constraint). The solution would further be enhanced to allow predictive analytics in the following areas;
                            <ul>
                                ...
                                <p>
                                On a final note, I am indebted to the supervisory team:Dr. Vani Vasudevan, Principal Supervisor; Associate Prof. MGM Khan, Co-Supervisor and Prof. Govinda Ishwar Lingam, Co-Supervisor, My Family and Abdul Jeleel in Nigeria for their sacrifices, while special appreciation goes to the Fiji Ministry of Education and International Development Partners whose data and reports guided the realization IEMIS. 
                                </p>
                            </Card.Body>
                        </Card>
                        </Col>
