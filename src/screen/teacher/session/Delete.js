...
export default function Delete(props) {
                    ...
                    <Row>
                        ...
                        <Card>
                            ...
                            <Card.Body>
                                <Row>
                                    <Col>
                                        <h1>Requesting to Delete Session </h1>
                                    </Col>
                                </Row>
                            </Card.Body>
                        </Card>
                    ...
                    <Row>
                        ...
                        <Card>
                            ...
                            <Card.Body>
                                <Row>
                                    <Col>
                                        <h1>Session data failed to delete, Try again <Button variant="primary" onClick={handleReload}>Reload</Button> </h1>
                                    </Col>
                                </Row>
                            </Card.Body>
                        </Card>
    ...
    React.useEffect(() => {
        ...
        Swal.fire({
            title: 'Do you sure to delete this ?',
